        ...
        foreach var attrEntry in entity.attributes {
            if attrEntry.key == attributeName {
                ...
                if tbvList.values.length() == 0 {
                    ...
                    return <RecordStringStartStringendStringvalueRecordStringStartStringendStringvalueArrayOk>{body: []};
                    ...
                    return <RecordStringStartStringendStringvalueRecordStringStartStringendStringvalueArrayOk>{body: response};
                } else {
