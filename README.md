...
**See OpenGIN in action**: [OpenGINXplore](https://github.com/LDFLK/openginxplore) is a reference application built with OpenGIN for exploring complex, time-aware datasets.
